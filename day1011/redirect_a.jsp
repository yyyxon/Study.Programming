...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page info="redirect 연습"%>
<%
//redirect : 정상적인 요청이 있는 페이지에서, 비정상적인 요청이 발생했을 때 페이지 이동을 수행
if(new Random().nextBoolean()) { //비정상적인 상황
	log("-----비정상적인 요청이 발생-----"); //= System.out.println (jsp에서는 log 메소드 사용)
...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <canvas class="my-4 w-100" id="myChart" width="1894" height="799" 
      style="display: block; box-sizing: border-box; height: 399px; width: 947px;"></canvas>
